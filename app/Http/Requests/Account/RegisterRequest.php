...
class RegisterRequest extends FormRequest
{
  ...
  public function rules(): array
  {
    return [
      ...
      'telephone' => [
        ...
        'unique:user', // Replace 'users' with the actual table name where uniqueness should be checked
      ],
      'email' => [
        'required',
  ...
  {
    return [
      'name.required' => 'Vui lòng nhập tên đầ đủ!',
      ...
      'telephone.unique' => 'Số điện thoại đã tồn tại trong hệ thống!'
    ];
  }
}
